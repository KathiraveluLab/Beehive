...
def update_profile_photo(username, filename):
    ...
    beehive_user_collection.update_one(
        {"username": username}, {"$set": {"profile_photo": filename}}
    )
...
def update_email(user_id, new_email):
    beehive_user_collection.update_one(
        {"_id": user_id}, {"$set": {"mail_id": new_email}}
    )
...
def update_image(image_id, title, description):
    beehive_image_collection.update_one(
        {"_id": image_id}, {"$set": {"title": title, "description": description}}
    )
